...
## Current next step
Keep pushing phase-2 usefulness: stronger batch review flow and TV/provider depth, then native filesystem apply/undo in Tauri/Rust.
