...
## Current next step
Stay focused on Milestone 4 until local execution is boringly trustworthy: tighten batch sequencing, collision reporting, partial-success recovery, and interruption-safe behavior. WebDAV remote execution stays explicitly deferred until the local lane is solid.
