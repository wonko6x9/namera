...
## Current next step
Harden execution semantics beyond the first native apply/undo lane, especially selective batch retry/recovery behavior, clearer collision reporting, and broader log-backed undo validation.
