...
## Current next step
Push phase 3 beyond transfer-contract previews into actual remote execution semantics, with the next honest seam being resumable/manual remote execution state instead of only handoff exports, while continuing to harden execution behavior, collision reporting, and richer recovery/reporting around partial success.
